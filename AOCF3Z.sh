...
echo $yellow
figlet -f smshadow "AOC defaceF3Z"
echo $indigo
date
echo $purple"___________________________________________________"
echo $cyan" ["$red"+"$cyan"]Author by	: F3Z_ID/F-RREL "
echo $cyan" ["$red"+"$cyan"]Team        : Bojonegoro Cyber Security	"
echo $cyan" ["$red"+"$cyan"]Blog        : https://f3zid.blogspot.com"
echo $cyan" ["$red"+"$cyan"]Github	: https://github.com/xF3Zx"
